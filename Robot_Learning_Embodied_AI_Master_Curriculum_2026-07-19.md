# Master Research Curriculum: Robot Learning, Embodied Intelligence, and Physical AI

**Literature-search cutoff:** 19 July 2026  
**Artifact type:** curriculum map, primary-paper inventory, supporting-material inventory, dependency structure, execution prioritization, and frontier watchlist  
**Inventory:** 37 topics · 193 primary papers · 26 supporting resources · 10 external watchlist items

> This document is the paper/resource specification. It deliberately excludes session agendas, presentation procedures, exercises, and general motivation already defined elsewhere.
...
|---|---|---|---|---:|
| F1 | A. Shared foundations | Research evidence, reproducibility, and empirical methodology | **Shared Core** | 4 |
| F2 | A. Shared foundations | Optimization and deep-learning mechanics | **Shared Core** | 4 |
| F3 | A. Shared foundations | Neural architectures and sequence models | **Shared Core** | 5 |
| F4 | A. Shared foundations | Self-supervised and generative learning | **Shared Core** | 6 |
| F5 | A. Shared foundations | Foundation-model training, post-training, and adaptation | **Shared Core** | 8 |
| F6 | A. Shared foundations | Robot mechanics, dynamics, and interaction control | **Shared Core** | 4 |
| F7 | A. Shared foundations | Motion planning, trajectory optimization, and optimal control | **Shared Core** | 6 |
| F8 | A. Shared foundations | State estimation, sensor fusion, and SLAM | **Shared Core** | 5 |
| P1 | B. Perception, spatial intelligence, and world models | Visual and multimodal representation learning | **Shared Core** | 5 |
| P2 | B. Perception, spatial intelligence, and world models | Detection, segmentation, grounding, and tracking | **Active Research Track** | 6 |
| P3 | B. Perception, spatial intelligence, and world models | 3D representation, reconstruction, and semantic mapping | **Active Research Track** | 7 |
| P4 | B. Perception, spatial intelligence, and world models | Video representation and predictive learning | **Active Research Track** | 5 |
| P5 | B. Perception, spatial intelligence, and world models | Learned dynamics, model-based RL, and world models | **Active Research Track** | 6 |
| L1 | C. Learning to act | Reinforcement-learning foundations | **Shared Core** | 5 |
| L2 | C. Learning to act | Deep model-free continuous control | **Shared Core** | 7 |
| L3 | C. Learning to act | Imitation learning and inverse reinforcement learning | **Shared Core** | 6 |
| L4 | C. Learning to act | Offline and offline-to-online reinforcement learning | **Active Research Track** | 6 |
| L5 | C. Learning to act | Goal-conditioned, hierarchical, meta-, and skill learning | **Specialization** | 6 |
| L6 | C. Learning to act | Generative action policies and action representations | **Active Research Track** | 5 |
| L7 | C. Learning to act | Sim-to-real transfer, system identification, and adaptation | **Active Research Track** | 5 |
| L8 | C. Learning to act | Safety, uncertainty, intervention, and constrained learning | **Active Research Track** | 5 |
| D1 | D. Data, evaluation, and research systems | Robot-data collection, teleoperation, and dataset construction | **Active Research Track** | 6 |
| D2 | D. Data, evaluation, and research systems | Robot-learning benchmarks, generalization, and failure analysis | **Shared Core** | 8 |
| D3 | D. Data, evaluation, and research systems | Research systems, experiment infrastructure, and reproducible training | **Active Research Track** | 4 |
| D4 | D. Data, evaluation, and research systems | Efficient deployment, latency, compression, and real-time policy execution | **Active Research Track** | 4 |
| D5 | D. Data, evaluation, and research systems | Synthetic data, learned simulators, and scalable data engines | **Specialization** | 5 |
| E1 | E. Language, multimodality, and embodied reasoning | Language-conditioned robotics, grounding, and task planning | **Active Research Track** | 6 |
| E2 | E. Language, multimodality, and embodied reasoning | Vision-language-action models and generalist robot policies | **Active Research Track** | 8 |
| E3 | E. Language, multimodality, and embodied reasoning | Embodied memory, agentic control, self-improvement, and world-action models | **Frontier Watchlist** | 5 |
| S1 | F. Specialization branches | Manipulation, grasping, contact, and bimanual control | **Specialization** | 5 |
| S2 | F. Specialization branches | Tactile sensing and dexterous manipulation | **Specialization** | 4 |
| S3 | F. Specialization branches | Legged locomotion and whole-body control | **Specialization** | 5 |
| S4 | F. Specialization branches | Navigation and embodied agents | **Optional** | 4 |
| S5 | F. Specialization branches | Deformable objects, learned physics, and graph models | **Optional** | 4 |
| S6 | F. Specialization branches | Multi-agent reinforcement learning | **Deferred** | 3 |
| S7 | F. Specialization branches | Differentiable physics, robot design, and co-optimization | **Deferred** | 2 |
| S8 | F. Specialization branches | Human feedback, shared autonomy, and human–robot interaction | **Optional** | 4 |
...
| 6 | [P095 — Cal-QL: Calibrated Offline RL Pre-Training for Efficient Online Fine-Tuning](https://arxiv.org/abs/2303.05479) | Advanced | Advanced |
...
| 6 | [P128 — RoboArena: A Community-Driven Real-World Benchmark for Generalist Robot Policies](https://robo-arena.github.io/) | Frontier Bridge; Critical | Advanced |
...
| Order | Paper | Role | Level |
|---:|---|---|---|
| 1 | [P135 — OpenVLA-OFT: Fine-Tuning Vision-Language-Action Models via Optimized Actions and Fast Inference](https://arxiv.org/abs/2502.19645) | Modern Core | Advanced |
...
| Order | Paper | Role | Level |
|---:|---|---|---|
| 1 | [P158 — VLAs with Long and Short-Term Memory](https://www.pi.website/research/memory) | Frontier | Expert |
| 2 | [P159 — π0.7: a Steerable Model with Emergent Capabilities](https://www.pi.website/blog/pi07) | Frontier | Expert |
| 3 | [P160 — Vesta: A Generalist Embodied Reasoning Model](https://research.nvidia.com/labs/gear/vesta/) | Frontier | Expert |
| 4 | [P161 — RoboTTT: Context Scaling for Robot Policies](https://research.nvidia.com/labs/gear/robottt/) | Frontier | Expert |
...
## 6. Complete primary-paper index
...
- **Authoritative version used:** Canonical public paper version linked
- **Official project/code:** Not identified or not publicly available at the cutoff.
- **Role / level / preparation:** Advanced · Advanced · High
...
##### P128. [RoboArena: A Community-Driven Real-World Benchmark for Generalist Robot Policies](https://robo-arena.github.io/)

- **Authors / year / venue:** RoboArena Collaboration · 2025 · arXiv / live benchmark
- **Authoritative version used:** Latest public technical report or arXiv version at cutoff
- **Official project/code:** Not identified or not publicly available at the cutoff.
...
- **Quality/influence signals:** Live public benchmark with DROID platform; medium maturity.
- **Metadata and assessment confidence:** Medium
...
##### P135. [OpenVLA-OFT: Fine-Tuning Vision-Language-Action Models via Optimized Actions and Fast Inference](https://arxiv.org/abs/2502.19645)

- **Authors / year / venue:** Moo Jin Kim et al. · 2025 · Robotics: Science and Systems
- **Authoritative version used:** Canonical public paper version linked
...
- **Authors / year / venue:** Dana Aubakirova et al. · 2025 · arXiv technical report
- **Authoritative version used:** Latest public technical report or arXiv version at cutoff
...
##### P158. [VLAs with Long and Short-Term Memory](https://www.pi.website/research/memory)

- **Authors / year / venue:** Marcel Torne et al. · 2026 · Physical Intelligence technical report
- **Authoritative version used:** Latest public technical report or arXiv version at cutoff
- **Official project/code:** Not identified or not publicly available at the cutoff.
- **Role / level / preparation:** Frontier · Expert · High
...
- **Quality/influence signals:** Official report with detailed ablations and demonstrations.
- **Metadata and assessment confidence:** Medium

##### P159. [π0.7: a Steerable Model with Emergent Capabilities](https://www.pi.website/blog/pi07)

- **Authors / year / venue:** Physical Intelligence et al. · 2026 · Physical Intelligence technical report
- **Authoritative version used:** Latest public technical report or arXiv version at cutoff
- **Official project/code:** Not identified or not publicly available at the cutoff.
...
- **Major positioning limitation:** Company-authored technical report; model, training data, and full independent reproduction are unavailable.
...
##### P160. [Vesta: A Generalist Embodied Reasoning Model](https://research.nvidia.com/labs/gear/vesta/)

- **Authors / year / venue:** Johan Bjorck et al. · 2026 · NVIDIA technical report
- **Authoritative version used:** Latest public technical report or arXiv version at cutoff
- **Official project/code:** Not identified or not publicly available at the cutoff.
- **Role / level / preparation:** Frontier · Expert · High
...
- **Major positioning limitation:** Very recent, organization-specific stack and limited task/platform evaluation.
- **Quality/influence signals:** Official report with real-robot and navigation experiments.
- **Metadata and assessment confidence:** Medium

##### P161. [RoboTTT: Context Scaling for Robot Policies](https://research.nvidia.com/labs/gear/robottt/)

- **Authors / year / venue:** NVIDIA GEAR et al. · 2026 · Technical report
- **Authoritative version used:** Latest public technical report or arXiv version at cutoff
- **Official project/code:** Not identified or not publicly available at the cutoff.
- **Role / level / preparation:** Frontier · Expert · High
- **Contribution:** Studies very long policy context and in-context adaptation learned from intervention histories.
- **Lineage and relationships:** Connects algorithm distillation, memory, and test-time policy improvement.
- **Major positioning limitation:** New and not independently reproduced; context cost and failure modes need analysis.
...
##### P176. [SONIC: Supersizing Motion Tracking for Natural Humanoid Whole-Body Control](https://arxiv.org/abs/2511.07820)

- **Authors / year / venue:** Zhengyi Luo et al. · 2025 · arXiv preprint
- **Authoritative version used:** Latest public technical report or arXiv version at cutoff
- **Official project/code:** Not identified or not publicly available at the cutoff.
- **Role / level / preparation:** Frontier · Expert · High
...
- **Major positioning limitation:** Very recent; specialized hardware/large data and limited independent reproduction.
- **Quality/influence signals:** Official project/code; high current relevance.
- **Metadata and assessment confidence:** Medium
...
## 7. Supporting-material index

These resources support reconstruction and implementation but are not counted as primary research papers.
...
### 8.1 Frontier papers already represented in the primary index

- **P158 — [VLAs with Long and Short-Term Memory](https://www.pi.website/research/memory)**: retain as a watch item; do not infer maturity from demonstrations alone.
- **P159 — [π0.7: a Steerable Model with Emergent Capabilities](https://www.pi.website/blog/pi07)**: retain as a watch item; do not infer maturity from demonstrations alone.
- **P160 — [Vesta: A Generalist Embodied Reasoning Model](https://research.nvidia.com/labs/gear/vesta/)**: retain as a watch item; do not infer maturity from demonstrations alone.
- **P161 — [RoboTTT: Context Scaling for Robot Policies](https://research.nvidia.com/labs/gear/robottt/)**: retain as a watch item; do not infer maturity from demonstrations alone.
- **P162 — [ENPIRE: Agentic Robot Policy Self-Improvement in the Real World](https://arxiv.org/abs/2606.19980)**: retain as a watch item; do not infer maturity from demonstrations alone.

### 8.2 External items not yet integrated into the durable paper sequence

| ID | Item | Date | Type | Promotion test |
|---|---|---|---|---|
| W001 | [V-JEPA 2.1: Unlocking Dense Features in Video Self-Supervised Learning](https://arxiv.org/abs/2603.14482) | 2026-03 | Paper / representation frontier | Adds dense predictive supervision and reports stronger robotics transfer; monitor for independent reproduction and comparison with action-conditioned world models. |
| W002 | [DreamZero: World Action Models are Zero-shot Policies](https://research.nvidia.com/labs/gear/) | 2026-02 | Paper / world-action frontier | Directly tests whether a learned world-action model can act zero-shot; highly relevant to P5/E3 but too new for durable core placement. |
| W003 | [EgoScale: Scaling Dexterous Manipulation with Diverse Egocentric Human Data](https://research.nvidia.com/labs/gear/publications/) | 2026-02 | Paper / human-video data | Potentially important bridge from human video to dexterous robot learning; verify data accessibility, transfer protocol, and ablations. |
| W004 | [SimFoundry: Modular and Automated Scene Generation for Policy Learning and Evaluation](https://research.nvidia.com/labs/gear/publications/) | 2026-06 | Paper / synthetic-data systems | Candidate for D5 if modular generation and evaluation results reproduce across simulators and policy families. |
| W005 | [ASPIRE: Agentic Skills Discovery for Robotics](https://research.nvidia.com/labs/gear/publications/) | 2026 | Paper / agentic skill discovery | Candidate E3 lineage for autonomous skill discovery and data loops; require stable paper metadata and independent evidence. |
| W006 | [Gemini Robotics-ER 1.6](https://ai.google.dev/gemini-api/docs/robotics-overview) | 2026-04 | Model / embodied reasoning | Current public preview of Google's embodied-reasoning VLM; useful as a system/resource, not yet a primary durable paper. |
| W007 | [GR00T N1.7 and the LeRobot 0.6 integration](https://huggingface.co/blog/lerobot-release-v060) | 2026-07 | Model and implementation ecosystem | Current open cross-embodiment implementation path; track against the historical GR00T N1 paper and independent benchmarks. |
| W008 | [VLA-JEPA, FastWAM, and LingBot-VA in LeRobot 0.6](https://huggingface.co/blog/lerobot-release-v060) | 2026-07 | World-model policy implementations | Useful experimental candidates for testing whether predictive auxiliary objectives improve control without unacceptable inference cost. |
| W009 | [Robometer and TOPReward](https://huggingface.co/blog/lerobot-release-v060) | 2026-07 | Reward-model ecosystem | Potentially important for autonomous success detection and data flywheels; require benchmark audits and false-positive analysis. |
| W010 | [AutoSERL: One Demonstration Is Enough for Real-World Robotic Reinforcement Learning](https://arxiv.org/abs/2607.01651) | 2026-07 | Paper / real-world RL | Direct successor candidate to SERL/HIL-SERL; monitor independent replication, task breadth, and safety assumptions. |

### Promotion criteria

A frontier item is promoted only when it materially changes a durable lineage and has sufficiently clear methodology, data provenance, baselines, evaluation protocol, failure analysis, compute requirements, and preferably code or independent reproduction.

## 9. Audit of `SolFindings.md`

| Finding | Disposition in this master curriculum |
|---|---|
| The prior document mixed curriculum construction with session format, meeting timing, and note templates. | All operational/session material is removed. This artifact contains only the knowledge map, papers, resources, dependencies, statuses, and frontier management. |
| The four broad competency areas were useful but too coarse for dependency-aware execution. | Replaced by six major areas and 37 explicit topics aligned with the governing scope. |
| Several entries were bundles rather than verifiable papers (`DINO and DINOv2`, `Dreamer series`, generic OpenAI dexterity systems). | Split into specific authoritative works or replaced with a single representative paper plus explicit lineage references. |
| Papers appeared repeatedly across generative policies, manipulation, shared core, and VLA sections. | Every paper now has one primary topic and one stable ID; other sections use cross-references. |
| Topic status, prerequisites, cross-area relations, and the complete-vs-executable distinction were absent. | Added for all topics. |
| Critical, replication, robustness, and benchmark-audit material was underrepresented. | Added F1, D2, L8, SimplerEnv, RoboArena, LIBERO-Plus, RobotArena∞, and empirical VLA design analysis. |
| Foundation-model lifecycle and research systems were incomplete. | Added scaling, post-training, PEFT/quantization, distributed training, serving, latency, experiment infrastructure, and deployment tracks. |
| Fast-moving VLA/company systems were presented close to durable core status. | Mature lineage is separated from E3 and the dated frontier watchlist; proprietary technical reports carry explicit evidence limitations. |
| Some metadata in the working inventory required correction. | Examples corrected during verification include HIL-SERL (Science Robotics, 2025), Learning to Manipulate Deformable Objects without Demonstrations (RSS 2020), and Learning from Interventions (AAAI 2020). |
| The earlier list ended before the current frontier. | Updated through 19 July 2026, including π0.7, current Gemini Robotics-ER, V-JEPA 2.1, DreamZero/DreamDojo-era work, LeRobot 0.6 integrations, and July 2026 real-world RL candidates. |

## 10. Revision and verification policy

- Record every material revision with date, affected topic/paper IDs, and reason.
- Replace a paper only when it is obsolete for its assigned role, not merely because a newer paper reports a higher benchmark score.
- Re-check all frontier metadata at least quarterly; re-check durable topics annually.
- When a paper has both a preprint and a peer-reviewed version, migrate the canonical link and metadata to the version of record while retaining code/project links.
- Mark exact quantitative statistics with source and retrieval date in topic-level plans; this master map intentionally avoids fragile citation-count snapshots.
- Topic planning may expose missing prerequisites or feasibility constraints, but session logistics must remain outside this file.

## 11. Compact change log

| Date | Change |
|---|---|
| 2026-07-19 | Rebuilt the curriculum from the goal and construction rules; audited the prior list; created the complete topic map, paper index, supporting-resource index, execution statuses, dependency graph, and frontier watchlist. |
