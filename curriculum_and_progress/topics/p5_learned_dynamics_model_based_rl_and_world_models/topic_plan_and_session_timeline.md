...
| R026 | [Model-based Reinforcement Learning: A Survey](https://arxiv.org/abs/2006.16712) | Survey | Taxonomy of learned models, planning, uncertainty, and policy learning. | S1, S8, S9, S10, S11 |
...
| 6 | **P070 — Mastering Diverse Control Tasks through World Models**<br>*Paper lineage — Modern Core* | Required Core | S5 | **Papers:** [P070 — Mastering Diverse Control Tasks through World Models](https://doi.org/10.1038/s41586-025-08744-2)<br>**Resources:** R004, R006 | Presents a robust latent world-model actor–critic recipe across diverse domains with one configuration. | Method/evidence reconstruction; limitation: Mostly simulated benchmarks; real-robot and model-bias questions remain. | Explain the method, assumptions, evidence, limitations, and lineage position.<br>Artifact: paper reconstruction; next S7. |
...
|---|---|---:|---|
| `SES-34F05C81-6EBD-587F-A410-5C44C2CA0C06` | `P5-S01` | 1 | Foundations — Dynamics uncertainty, compounding error, latent state-space models |
| `SES-A5F31F5C-F8C2-598E-8773-873EB8761BF1` | `P5-S02` | 2 | P066 — PILCO: A Model-Based and Data-Efficient Approach to Policy Search |
| `SES-18322EC0-A702-57F9-BA5E-1D5DB77AC194` | `P5-S03` | 3 | P067 — Deep Reinforcement Learning in a Handful of Trials using Probabilistic Dynamics Models |
| `SES-E1EEFCE0-1CC7-5B33-80FF-16A624E1A78D` | `P5-S04` | 4 | P068 — Learning Latent Dynamics for Planning from Pixels |
| `SES-8E64E654-EC92-5D9C-9832-2FB8E30CD36C` | `P5-S05` | 5 | P069 — Mastering Atari, Go, Chess and Shogi by Planning with a Learned Model |
| `SES-8101F2B1-B4C0-5222-84F5-25D3CDF717D5` | `P5-S06` | 6 | P070 — Mastering Diverse Control Tasks through World Models |
| `SES-C930771A-8A5E-513B-957D-55066D624EE3` | `P5-S07` | 7 | P071 — TD-MPC2: Scalable, Robust World Models for Continuous Control |
| `SES-C55C8179-A7BF-5CFA-955E-62E90FA16BAE` | `P5-S08` | 8 | Unified reconstruction and method comparison |
| `SES-D2D25683-99AB-596C-ABAF-6424280437D9` | `P5-S09` | 9 | Controlled implementation and evaluation |
| `SES-567EDE18-8798-5AC4-AEED-97B9FE6A8AC0` | `P5-S10` | 10 | Evidence, limitations, and system interpretation |
| `SES-8AA79B3F-A394-5C32-8B4D-5425AAB4E5D2` | `P5-S11` | 11 | Synthesis and research directions |
