...
| 6 | **P127 — Evaluating Real-World Robot Manipulation Policies in Simulation**<br>*Paper lineage — Modern Core; Critical* | Required Core | S5 | **Papers:** [P127 — Evaluating Real-World Robot Manipulation Policies in Simulation](https://proceedings.mlr.press/v270/li25c.html)<br>**Resources:** R017, R018 | Evaluates real-robot policies in simulation designed to preserve policy ranking and behavior. | Method/evidence reconstruction; limitation: Real-to-sim fidelity and ranking correlation remain embodiment/task dependent. | Explain the method, assumptions, evidence, limitations, and lineage position.<br>Artifact: paper reconstruction; next S7. |
| 7 | **Unified reconstruction and method comparison**<br>*Reconstruction and lineage integration* | Required Core | S1–S6 | **Papers:** P123, P124, P125, P126, P127<br>**Resources:** R017, R018, R019, R032 | Compare RLBench, CALVIN, LIBERO, ManiSkill2, and SimplerEnv as durable evaluation claims and infrastructures. RoboArena, LIBERO-Plus, RobotArena∞, and GPUSimBench remain in the continuation synthesis at S15. | Unified derivation, architecture/data-flow diagram, and method comparison table. | Compare the required methods in one notation and separate conceptual, implementation, data, and scale differences.<br>Artifact: comparison matrix; next S8. |
...
|---|---|---:|---|
| `SES-E8CD886F-9FA0-59D8-88C3-9DFC20F2A9E2` | `D2-S01` | 1 | Foundations — Task contracts, success metrics, episode sampling |
| `SES-A9ED0010-D960-5FC1-8B54-8B07C1A3ECAD` | `D2-S02` | 2 | P123 — RLBench: The Robot Learning Benchmark & Learning Environment |
| `SES-B6DF4D81-8ECF-5A15-9132-D48B6CA52BB2` | `D2-S03` | 3 | P124 — CALVIN: A Benchmark for Language-Conditioned Policy Learning for Long-Horizon Robot Manipulation Tasks |
| `SES-6B28EFE1-27B9-58D9-A16A-0CF5B8751020` | `D2-S04` | 4 | P125 — LIBERO: Benchmarking Knowledge Transfer for Lifelong Robot Learning |
| `SES-5F77F8D7-6F37-5284-B754-324C01F8ACF4` | `D2-S05` | 5 | P126 — ManiSkill2: A Unified Benchmark for Generalizable Manipulation Skills |
| `SES-AEA5C6AC-64E7-54CD-A64B-F26097EA677D` | `D2-S06` | 6 | P127 — Evaluating Real-World Robot Manipulation Policies in Simulation |
| `SES-F80CB41A-52AE-54AF-9683-6D20C67FF4BC` | `D2-S07` | 7 | Unified reconstruction and method comparison |
| `SES-759565F6-1B05-51EC-BEBA-4100C02C0A83` | `D2-S08` | 8 | Controlled implementation and evaluation |
| `SES-47EDF897-B65D-5605-BE37-B9D4D283F97B` | `D2-S09` | 9 | Evidence, limitations, and system interpretation |
| `SES-7C4286AA-28ED-5850-9953-E1CF354E4C93` | `D2-S10` | 10 | Synthesis and research directions |
| `SES-8785BD3E-BA53-5E23-9C6D-BA39E482C55D` | `D2-S11` | 11 | P128 — RoboArena: Distributed Real-World Evaluation of Generalist Robot Policies |
| `SES-C947D4FC-639D-5FA5-8B24-0A8DA54FD149` | `D2-S12` | 12 | P129 — LIBERO-Plus: A Progressive Robustness Benchmark for Visual-Language-Action Models |
| `SES-D4CB51EB-2BB8-527E-B57C-6F147430ED6B` | `D2-S13` | 13 | P130 — RobotArena∞: Scalable Robot Benchmarking via Real-to-Sim Translation |
| `SES-B1941CA2-F66B-5723-AEC7-11CE6B1F65B7` | `D2-S14` | 14 | Frontier — GPU simulator validity, scaling, and determinism |
| `SES-3400C2C4-11B0-58E2-ABE5-DB1CFEE2BC90` | `D2-S15` | 15 | Frontier synthesis and promotion review |
