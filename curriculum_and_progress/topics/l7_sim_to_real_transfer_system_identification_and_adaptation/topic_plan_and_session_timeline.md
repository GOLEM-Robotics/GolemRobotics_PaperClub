...
| R030 | [ROS 2 Real-Time Programming Documentation](https://docs.ros.org/en/lyrical/Tutorials/Demos/Real-Time-Programming.html) | Supporting resource | Deadline, jitter, memory-allocation, scheduling, and execution-path constraints for physical robot deployment. | S1, S7, S8, S9, S10, S12 |
...
| 4 | **P109 — Closing the Sim-to-Real Loop: Adapting Simulation Randomization with Real World Experience**<br>*Paper lineage — Modern Core* | Required Core | S3 | **Papers:** [P109 — Closing the Sim-to-Real Loop: Adapting Simulation Randomization with Real World Experience](https://arxiv.org/abs/1810.05687)<br>**Resources:** R006, R019 | Updates simulator-parameter distributions from real trajectories to improve transfer. | Method/evidence reconstruction; limitation: Requires informative real rollouts and chosen simulator parameterization. | Explain the method, assumptions, evidence, limitations, and lineage position.<br>Artifact: paper reconstruction; next S5. |
...
|---|---|---:|---|
| `SES-36BE6B95-9C38-5C9E-B97D-B4F7B892A0AC` | `L7-S01` | 1 | Foundations — Parameter distributions, system identification, observability of dynamics |
| `SES-5A9B3342-48BD-505C-BC8B-528B641892E2` | `L7-S02` | 2 | P107 — Domain Randomization for Transferring Deep Neural Networks from Simulation to the Real World |
| `SES-84AE103B-E3CE-5DCE-92BA-86C393F9E642` | `L7-S03` | 3 | P108 — Sim-to-Real Transfer of Robotic Control with Dynamics Randomization |
| `SES-2B633667-2ECD-5693-96D9-39A0F86B3136` | `L7-S04` | 4 | P109 — Closing the Sim-to-Real Loop: Adapting Simulation Randomization with Real World Experience |
| `SES-10897F51-19C5-5198-ABE0-FD7398400795` | `L7-S05` | 5 | P110 — Learning Agile and Dynamic Motor Skills for Legged Robots |
| `SES-18907F8D-CBB8-579C-A405-89FFD926A56D` | `L7-S06` | 6 | P111 — RMA: Rapid Motor Adaptation for Legged Robots |
| `SES-0D8A4D9A-9664-5AC1-8A11-C6BE7C36D7AB` | `L7-S07` | 7 | Unified reconstruction and method comparison |
| `SES-E4BF135F-B4D1-5504-A6CD-C7B4B53A2B80` | `L7-S08` | 8 | Controlled implementation and evaluation |
| `SES-90749775-93A5-5346-A35E-92BE1710E29A` | `L7-S09` | 9 | Evidence, limitations, and system interpretation |
| `SES-6F79882B-618D-52F9-A39E-F298EFE1D064` | `L7-S10` | 10 | Synthesis and research directions |
| `SES-BC8DBD99-F337-560A-B719-45B6643DF800` | `L7-S11` | 11 | Frontier — GPU simulator validity, scaling, and determinism |
| `SES-5031F0D1-FFD3-5395-BDC3-27C489EE3E08` | `L7-S12` | 12 | Frontier synthesis and promotion review |
