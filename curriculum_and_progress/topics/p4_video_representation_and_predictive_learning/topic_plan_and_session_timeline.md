...
| 5 | **P064 — Revisiting Feature Prediction for Learning Visual Representations from Video**<br>*Paper lineage — Modern Core* | Required Core | S4 | **Papers:** [P064 — Revisiting Feature Prediction for Learning Visual Representations from Video](https://openreview.net/forum?id=QaCCuDfBk2)<br>**Resources:** R013, R023 | Introduces V-JEPA and shows feature prediction can learn strong frozen video representations without pixel reconstruction or text. | Method/evidence reconstruction; limitation: Action-free representation quality does not itself establish planning capability. | Explain the method, assumptions, evidence, limitations, and lineage position.<br>Artifact: paper reconstruction; next S6. |
...
|---|---|---:|---|
| `SES-1757E685-DC60-589D-AA11-1D57E0500E8D` | `P4-S01` | 1 | Foundations — Temporal sampling, predictive coding, masked video modeling |
| `SES-61F57C91-6186-5850-82AB-6C9EB53168AA` | `P4-S02` | 2 | P061 — Representation Learning with Contrastive Predictive Coding |
| `SES-8FBCF7AD-C3B5-55FC-980B-F47DB56D0B06` | `P4-S03` | 3 | P062 — VideoMAE: Masked Autoencoders are Data-Efficient Learners for Self-Supervised Video Pre-Training |
| `SES-48482059-564C-542C-A3EE-0D27B9B1DD08` | `P4-S04` | 4 | P063 — Self-Supervised Learning from Images with a Joint-Embedding Predictive Architecture |
| `SES-73D846DD-19DD-5031-837A-CB3767EE3B0E` | `P4-S05` | 5 | P064 — Revisiting Feature Prediction for Learning Visual Representations from Video |
| `SES-A0C1CFAC-BEBC-52FC-B2EE-D29A6650411A` | `P4-S06` | 6 | Unified reconstruction and method comparison |
| `SES-8AB58EE9-78D9-56A4-B971-0441459B9F89` | `P4-S07` | 7 | Controlled implementation and evaluation |
| `SES-794EF791-AB94-5F6C-A05E-E68C1EC7E29D` | `P4-S08` | 8 | Evidence, limitations, and system interpretation |
| `SES-F3F85D61-2AC2-5E0D-94E3-04E438CD7C35` | `P4-S09` | 9 | Synthesis and research directions |
| `SES-4C9AB799-A727-5EA4-8B06-6888DAEB8E2D` | `P4-S10` | 10 | P065 — V-JEPA 2: Self-Supervised Video Models Enable Understanding, Prediction and Planning |
| `SES-DFEF5E24-6202-5855-ACBC-86BA0AD1C9A9` | `P4-S11` | 11 | Frontier synthesis and promotion review |
