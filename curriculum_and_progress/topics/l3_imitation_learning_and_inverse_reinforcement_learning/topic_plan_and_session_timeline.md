...
| 3 | **P085 — Maximum Entropy Inverse Reinforcement Learning**<br>*Paper lineage — Foundation* | Required Core | S2 | **Papers:** [P085 — Maximum Entropy Inverse Reinforcement Learning](https://aaai-24.aaai.org/Library/AAAI/2008/aaai08-227.php)<br>**Resources:** R001, R004 | Infers rewards by maximum-entropy trajectory modeling. | Method/evidence reconstruction; limitation: Reward identifiability and dynamics knowledge remain difficult; use the author-corrected algorithm version. | Explain the method, assumptions, evidence, limitations, and lineage position.<br>Artifact: paper reconstruction; next S4. |
...
|---|---|---:|---|
| `SES-BEB40023-D412-5ABA-A1FC-1A60556475A0` | `L3-S01` | 1 | Foundations — Supervised policy learning, covariate shift, compounding error |
| `SES-54403B62-3922-5AC0-A320-CF02930BF304` | `L3-S02` | 2 | P084 — A Reduction of Imitation Learning and Structured Prediction to No-Regret Online Learning |
| `SES-3790B5A0-00E0-5372-9C72-7583EBE4B532` | `L3-S03` | 3 | P085 — Maximum Entropy Inverse Reinforcement Learning |
| `SES-AEB1DEB8-2037-572E-81E2-77BA81F8FFEC` | `L3-S04` | 4 | P086 — Generative Adversarial Imitation Learning |
| `SES-03094E1D-5C6A-58A4-9884-A4D56C9ECB98` | `L3-S05` | 5 | P087 — Learning Robust Rewards with Adversarial Inverse Reinforcement Learning |
| `SES-0A1913B2-2384-504A-804F-B2643438CA51` | `L3-S06` | 6 | P088 — Learning Complex Dexterous Manipulation with Deep Reinforcement Learning and Demonstrations |
| `SES-48D0021E-C879-5FE7-ACF7-F7F322A46A10` | `L3-S07` | 7 | P089 — What Matters in Learning from Offline Human Demonstrations for Robot Manipulation |
| `SES-898D18B9-9C9D-5F68-9333-052A043B9EC8` | `L3-S08` | 8 | Unified reconstruction and method comparison |
| `SES-2D40A7F3-F2A3-557B-9C0C-D071E249B7D4` | `L3-S09` | 9 | Controlled implementation and evaluation |
| `SES-8B042E4A-03BF-5229-AC8C-D81929E3AD9E` | `L3-S10` | 10 | Evidence, limitations, and system interpretation |
| `SES-D318275B-2926-5C4F-B838-FF17148D3931` | `L3-S11` | 11 | Synthesis and research directions |
