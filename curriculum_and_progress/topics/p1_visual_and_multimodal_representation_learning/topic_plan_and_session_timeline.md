...
| 6 | **P047 — What Makes Pre-Trained Visual Representations Successful for Robust Manipulation?**<br>*Paper lineage — Critical; Bridge* | Required Core | S5 | **Papers:** [P047 — What Makes Pre-Trained Visual Representations Successful for Robust Manipulation?](https://proceedings.mlr.press/v270/burns25a.html)<br>**Resources:** R012, R013 | Compares 15 pretrained visual models and identifies emergent segmentation as a strong correlate of out-of-distribution manipulation robustness. | Method/evidence reconstruction; limitation: The relationship is correlational and suite-specific, with mostly simulated evidence and one offline real-robot setting. | Explain the method, assumptions, evidence, limitations, and lineage position.<br>Artifact: paper reconstruction; next S7. |
...
|---|---|---:|---|
| `SES-41C1F6CC-D904-59AC-8423-766670C6F05B` | `P1-S01` | 1 | Foundations — Global versus dense representations, contrastive alignment, self-distillation |
| `SES-5177A7EA-E4C4-5519-9131-D90152AF83CB` | `P1-S02` | 2 | P043 — Learning Transferable Visual Models From Natural Language Supervision |
| `SES-A11EEB76-7189-5414-BEB5-27990A181776` | `P1-S03` | 3 | P044 — Emerging Properties in Self-Supervised Vision Transformers |
| `SES-5C175B6D-8207-5B61-8605-BA035749DBD3` | `P1-S04` | 4 | P045 — DINOv2: Learning Robust Visual Features without Supervision |
| `SES-E8A66CD3-F06B-5886-9790-70C309989614` | `P1-S05` | 5 | P046 — Sigmoid Loss for Language Image Pre-Training |
| `SES-63EE56B6-F49D-5DB6-ABCF-9BE372F2478F` | `P1-S06` | 6 | P047 — What Makes Pre-Trained Visual Representations Successful for Robust Manipulation? |
| `SES-07E91776-E05A-5922-A9EB-EFA466091917` | `P1-S07` | 7 | Unified reconstruction and method comparison |
| `SES-3F557A2F-D63A-5855-9A69-200FDF128C36` | `P1-S08` | 8 | Controlled implementation and evaluation |
| `SES-257322A4-89EA-5616-9B27-75E0C652E16A` | `P1-S09` | 9 | Evidence, limitations, and system interpretation |
| `SES-E03027F6-3601-58C4-B01E-6DD73E087B99` | `P1-S10` | 10 | Synthesis and research directions |
