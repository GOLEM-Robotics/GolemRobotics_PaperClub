...
|---|---|---:|---|
| `SES-2BEA476E-176B-578A-80B4-22E4ECA79051` | `S4-S01` | 1 | Foundations — Navigation task definitions, egocentric observations, mapping/memory |
| `SES-1E3740BD-4BE8-5278-A83F-9939B16B0636` | `S4-S02` | 2 | P177 — Cognitive Mapping and Planning for Visual Navigation |
| `SES-AFE55D74-02C2-558B-BD71-9E6E7710D3D5` | `S4-S03` | 3 | P178 — Habitat: A Platform for Embodied AI Research |
| `SES-80E60973-0553-5642-88B4-B98163120AFE` | `S4-S04` | 4 | P179 — Vision-and-Language Navigation: Interpreting Visually-Grounded Navigation Instructions in Real Environments |
| `SES-4C47D637-B330-52A0-9FEC-843DA0957960` | `S4-S05` | 5 | P180 — Learning to Explore using Active Neural SLAM |
| `SES-DF9B6B2A-D482-5245-A482-FECB45B54CB4` | `S4-S06` | 6 | Unified reconstruction and method comparison |
| `SES-F4D48451-BC2E-5030-8C1A-A37B1C9FC121` | `S4-S07` | 7 | Evidence, limitations, and system interpretation |
| `SES-6B999E98-768F-5B28-97FF-4FC4433850A5` | `S4-S08` | 8 | Synthesis and research directions |
| `SES-23D76D84-9508-5475-A50C-848C7A4798CD` | `S4-S09` | 9 | Controlled implementation and evaluation |
| `SES-800A1C0B-7710-503D-8918-7EF4E037D30B` | `S4-S10` | 10 | Optional branch synthesis and activation decision |
| `SES-DB4107C8-1619-52EC-A4E0-DB7E55E09AFA` | `S4-S11` | 11 | Frontier — Isaac-Lab human-aware navigation benchmarks |
| `SES-A9A25185-500B-5FA9-AD07-DE0A8C7E18A6` | `S4-S12` | 12 | Frontier synthesis and promotion review |
