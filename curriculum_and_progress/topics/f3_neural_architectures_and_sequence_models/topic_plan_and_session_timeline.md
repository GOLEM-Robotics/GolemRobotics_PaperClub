...
| 5 | **Unified reconstruction and method comparison**<br>*Reconstruction and lineage integration* | Required Core | S1–S4 | **Papers:** P009, P010, P011<br>**Resources:** R011, R012, R014, R027 | Build a shape- and equation-level comparison of residual, Transformer, and ViT blocks; state-space models remain an explicitly activated optional branch. | Unified derivation, architecture/data-flow diagram, and method comparison table. | Compare the required methods in one notation and separate conceptual, implementation, data, and scale differences.<br>Artifact: comparison matrix; next S6. |
| 6 | **Controlled implementation and evaluation**<br>*Implementation / reproduction / controlled evaluation* | Required Core | S5; required compute/data/simulator/hardware | **Papers:** —<br>**Resources:** R011, R012, R014, R027 | Implement minimal residual and attention blocks; verify masking and tensor behavior and profile sequence-length scaling. Add a selective-state-space block only when the optional branch is activated. | Implement minimal residual and attention blocks; verify masking and tensor behavior and profile sequence-length scaling. | Run or audit the controlled comparison and separate method, implementation, data, optimization, and infrastructure effects.<br>Artifact: experiment record; next S7. |
...
|---|---|---:|---|
| `SES-F5AADC07-D1A2-5FB3-922F-1BDF9D6FFB68` | `F3-S01` | 1 | Foundations — Tensor shapes, convolution and residual paths, sequence tokenization |
| `SES-3FE1A75D-8314-580A-8627-75DE970462CC` | `F3-S02` | 2 | P009 — Deep Residual Learning for Image Recognition |
| `SES-220A3F0A-B416-5E1B-AC37-685EA460EE0D` | `F3-S03` | 3 | P010 — Attention Is All You Need |
| `SES-23B91FB8-F841-5336-97E1-56E66554C53C` | `F3-S04` | 4 | P011 — An Image Is Worth 16×16 Words: Transformers for Image Recognition at Scale |
| `SES-42D7444B-634F-5CBC-8F96-2914DD8BE7B7` | `F3-S05` | 5 | Unified reconstruction and method comparison |
| `SES-066B778F-1D30-5CE9-960C-8CA3D868EDE8` | `F3-S06` | 6 | Controlled implementation and evaluation |
| `SES-DDF97179-E96C-5676-9736-52FF1C9D6C8F` | `F3-S07` | 7 | Evidence, limitations, and system interpretation |
| `SES-04EFB321-16A6-59E8-A87E-D6F3A15FBC89` | `F3-S08` | 8 | Synthesis and research directions |
| `SES-9DDB8EFD-0950-5002-B3B2-062E604EA801` | `F3-S09` | 9 | P012 — Efficiently Modeling Long Sequences with Structured State Spaces |
| `SES-4598B7AE-F915-5E0F-8CE3-AD543868AA7E` | `F3-S10` | 10 | P013 — Mamba: Linear-Time Sequence Modeling with Selective State Spaces |
| `SES-2153CABB-9E58-5083-8BC1-2AC6216944BA` | `F3-S11` | 11 | Optional branch synthesis and activation decision |
